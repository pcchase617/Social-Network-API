...
router.put('/', async(req,res)=> {
    try{
        let updateThought = await Thought.findOneAndUpdate({_id: req.body.thoughtId}, {$set: req.body}, {runValidators: true, new: true})
...
router.delete('/:thoughtId', async(req,res)=> {
    try{
        let deleteThought = await Thought.findOneAndDelete({_id: req.params.thoughtId})
...
router.delete('/:thoughtId/reactions/:reactionId', async(req,res)=> {
    try {
        let deleteReaction = await Thought.findOneAndUpdate({_id: req.params.thoughtId}, {$pull: {reactionId: req.params.reactionId}}, {runValidators: true, new: true})
