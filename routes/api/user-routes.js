...
router.delete("/:userId", async (req, res) => {
  try {
    ...
    console.log("test123543", deleteUser);
    console.log("THOUGHTS", deleteUser.thoughts)
    deleteUser && await Thought.deleteMany({ _id: { $in: deleteUser.thoughts } })
...
router.delete("/:userId/friends/:friendId", async (req, res) => {
  try {
    let deleteFriend = await User.findOneAndUpdate(
      { _id: req.params.userId },
